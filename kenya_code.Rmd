...
#ANOVA
##H3: There is a significant difference in "Male," "Female," and "Intersex" populations across counties.

#Mediation
##H4: There is an interaction effect between "Population" density and "Farming" activities, where the impact of farming on household size is more pronounced in densely populated counties.
...
summary_model <- summary(tea_model)

apa_table <- apa_print.(summary_model)
