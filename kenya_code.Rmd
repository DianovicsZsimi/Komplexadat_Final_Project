...
```{r}
cor(counties_data_no_capital$Population, counties_data_no_capital$Farming)
...
#Huber regression
robust_pop_farming <- lmrob(Farming ~ Population, data = counties_data)
glance(robust_pop_farming)
```
